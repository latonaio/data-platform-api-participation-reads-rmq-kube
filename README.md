...
## 動作環境
data-platform-api-participation-reads-rmq-kube の動作環境は、次の通りです。  
・ OS: LinuxOS （必須）  
・ CPU: ARM/AMD/Intel（いずれか必須）  

## 本レポジトリ が 対応する API サービス
data-platform-api-participation-reads-rmq-kube が対応する APIサービス は、次のものです。

APIサービス URL: https://xxx.xxx.io/api/API_PARTICIPATION_SRV/reads/
...
```
	"api_schema": "DPFMParticipationReads",
	"accepter": ["Header"],
```
